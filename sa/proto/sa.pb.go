...
type GetRevokedCertsRequest struct {
	...
	IssuedAfter   int64 `protobuf:"varint,2,opt,name=issuedAfter,proto3" json:"issuedAfter,omitempty"`     // Unix timestamp (nanoseconds)
	IssuedBefore  int64 `protobuf:"varint,3,opt,name=issuedBefore,proto3" json:"issuedBefore,omitempty"`   // Unix timestamp (nanoseconds)
...
func (x *GetRevokedCertsRequest) GetIssuedAfter() int64 {
	if x != nil {
...
func (x *GetRevokedCertsRequest) GetIssuedBefore() int64 {
	if x != nil {
...
type GetRevokedCertsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetRevokedCertsResponse) Reset() {
	*x = GetRevokedCertsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetRevokedCertsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRevokedCertsResponse) ProtoMessage() {}

func (x *GetRevokedCertsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sa_proto_msgTypes[43]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRevokedCertsResponse.ProtoReflect.Descriptor instead.
func (*GetRevokedCertsResponse) Descriptor() ([]byte, []int) {
	return file_sa_proto_rawDescGZIP(), []int{43}
}

func (x *GetRevokedCertsResponse) GetSerial() string {
	if x != nil {
		return x.Serial
	}
	return ""
...
func (x *GetRevokedCertsResponse) GetReason() int32 {
	if x != nil {
		return x.Reason
	}
	return 0
...
func (x *GetRevokedCertsResponse) GetRevokedAt() int64 {
	if x != nil {
		return x.RevokedAt
	}
	return 0
...
var file_sa_proto_rawDesc = []byte{
	...
	0x53, 0x65, 0x6e, 0x74, 0x22, 0xa8, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x52, 0x65, 0x76, 0x6f,
	...
	,
	...
	0x76, 0x6f, 0x6b, 0x65, 0x64, 0x41, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72,
	0x65, 0x76, 0x6f, 0x6b, 0x65, 0x64, 0x41, 0x74, 0x32, 0xea, 0x16, 0x0a, 0x10, 0x53, 0x74, 0x6f,
	...
	0x00, 0x30, 0x01, 0x12, 0x4e, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65,
	...
	0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x73, 0x61, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x76, 0x6f, 0x6b,
	0x65, 0x64, 0x43, 0x65, 0x72, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
...
var file_sa_proto_goTypes = []interface{}{
	...
	(*GetRevokedCertsResponse)(nil),            // 43: sa.GetRevokedCertsResponse
...
var file_sa_proto_depIdxs = []int32{
	...
	50, // 38: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	50, // 39: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	...
	50, // 57: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	50, // 58: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	7,  // 59: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	51, // 60: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	51, // 61: sa.StorageAuthority.GetPrecertificate:output_type -> core.Certificate
	52, // 62: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	...
	47, // 70: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	30, // 71: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	47, // 72: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	...
	43, // 79: sa.StorageAuthority.GetRevokedCerts:output_type -> sa.GetRevokedCertsResponse
	50, // 80: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
...
func file_sa_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sa_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRevokedCertsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
